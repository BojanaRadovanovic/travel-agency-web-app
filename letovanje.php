...
<html lang="en">
  <head>
    ...
    <title>BoVoyage - Letovanja</title>
...
<?php include 'header.php'; ?>
 ...
 <section>
  <div class="container">
    <div class="row">
      <?php
      // Poziva se zajednicka konekcija s bazom
      require 'db.php';
      
      // Dohvatamo letovanja iz baze (ID od 19 do 27)
  $rezultati = $conn->query("SELECT * FROM destinacije WHERE kategorija = 'letovanja' AND tip_ponude = 'regular' ORDER BY id DESC");
      
      // Ako ima rezultata, ispisujemo ih kroz petlju
      if($rezultati && $rezultati->num_rows > 0):
      ...
      <div class="col-12 col-md-4 d-flex align-items-stretch mb-4">
        <div class="card1">
          ...
          <div class="card-body">
            <h5 class="card-title" style="margin-top: 20px;"><?php echo $red['naziv']; ?></h5><hr>
      ...
      <div class="col-12 text-center">
        <p>Trenutno nema dostupnih letovanja.</p>
      </div>
      <?php endif; ?>
    </div>
  </div>
