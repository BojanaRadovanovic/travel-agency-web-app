...
<html lang="en">
  <head>
    ...
    <title>BoVoyage - Rezervacija poruka</title>
  ...
  <?php include 'header.php'; ?>
    ...
    <h2 class="display-4">Obaveštenje o rezervaciji</h2>
  <hr>
  <div class="row">
    <div class="col-12">
      <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">Rezervacija je uspešno poslata!</h4>
        <p>Hvala vam na ukazanom poverenju. Naš tim će vas uskoro kontaktirati sa svim detaljima putovanja.</p>
        <hr>
        <p class="mb-0">Nazad na <a href="index.php" class="alert-link">početnu stranu</a> ili pogledajte <a href="letovanje.php" class="alert-link">letovanja</a>.</p>
      </div>
    </div>
  </div>
</div>
