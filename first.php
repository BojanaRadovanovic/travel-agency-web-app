...
<head>
    ...
    <title>BoVoyage - First minute</title>
...
<div class="container my-5">
    ...
    // Uzimamo destinaciju koja je označena kao first minute
    $rezultat = $conn->query("SELECT * FROM destinacije WHERE tip_ponude = 'first_minute' LIMIT 1");
    ...
    <?php else: ?>
        <div class="alert alert-info text-center">Trenutno nema dostupne first minute ponude.</div>
    <?php endif; ?>
</div>
