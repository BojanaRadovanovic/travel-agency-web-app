...
<html lang="en">
  <head>
    ...
    <title>BoVoyage - Mapa sajta</title>
...
<div class="container mt-4">
  <h2 class="display-4 mt-4">Mapa sajta</h2>
  <hr>

  <div class="row">

    <div class="col-12 col-md-4 mb-5">
      <h5 class="mb-3">Opšte</h5>
      <ul class="list-unstyled mb-0">
        <li><a href="index.php">Početna</a></li>
        <li><a href="onama.php">O nama</a></li>
        <li><a href="galerija.php">Galerija</a></li>
        <li><a href="kontakt.php">Kontakt</a></li>
        <li><a href="faq.php">Često postavljana pitanja</a></li>
         <li><a href="rezervacija.php">Rezervacija</a></li>
        <li><a href="nalog.php">Moj nalog</a></li>
      </ul>
    </div>

    
    <div class="col-12 col-md-4 mb-5">
      <h5 class="mb-3">Ponude</h5>
      <ul class="list-unstyled mb-0">
        <li><a href="popularno.php">Najpopularnije destinacije</a></li>
        <li><a href="first.php">First Minute</a></li>
        <li><a href="last.php">Last Minute</a></li>
      </ul>
    </div>

    
    <div class="col-12 col-md-4 mb-5">
      <h5 class="mb-3">Kategorije putovanja</h5>
      <ul class="list-unstyled mb-0">
        <li><a href="izletiEvropa.php">Izleti Evropa</a></li>
        <li><a href="IzletiSrbija.php">Izleti Srbija</a></li>
        <li><a href="letovanje.php">Letovanja</a></li>
      </ul>
    </div>
  </div>
</div>
