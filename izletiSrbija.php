...
<html lang="en">
  <head>
    ...
    <title>BoVoyage - Izleti Srbija</title>
...
<section>
  <div class="container">
    ...
    require 'db.php';
      ...
      // Dohvatamo izlete u Srbiji (ID od 10 do 18)
     $rezultati = $conn->query("SELECT * FROM destinacije WHERE kategorija = 'izletiSrbija' AND tip_ponude = 'regular' ORDER BY id DESC");
